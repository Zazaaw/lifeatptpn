...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-card border border-border/70 bg-card/85 text-card-foreground shadow-[0_24px_48px_-36px_hsl(var(--foreground)/0.35)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("text-lead font-bold leading-snug tracking-tight", className)}
    {...props}
  />
));
